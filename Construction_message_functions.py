...
def form_work(tem_p, hum_p, rain_p, message_list):         #거푸집공사
...
def drain_page_works(tem_p, hum_p, rain_p, message_list):       #하수도공사
...
def reinforcing_bar_work(tem_p, hum_p, rain_p, message_list):       #철근공사
...
def concrete_work(tem_p, hum_p, rain_p, message_list):        #콘크리트공사
    if tem_p <= 4:
...
def water_proof(tem_p, hum_p, rain_p, message_list):      #방수공사
    if 5 < tem_p < 25:
...
def masonry(tem_p, hum_p, rain_p, message_list):     #조적공사
...
def tiling(tem_p, hum_p, rain_p, message_list):     #타일공사
...
def joiners_work(tem_p, hum_p, rain_p, message_list):     #창호공사
