...
def making_text(tem_p, hum_p, rain_p, message_list, checkBox_object, num):
    work_list = ["1.토공사", "2.거푸집공사", "3.하수도공사", "4.철근공사",  "5.콘크리트공사", "6.방수공사", "7.도장공사", "8.미장공사", "9.조적공사", "10.타일공사", "11.창호공사"]
    ...
    if num == 1:
        if checkBox_object.isChecked()==True:
            work_name = work_list[num-1]
            message_list.append(["", "<<{}>>".format(work_name)])
            if tem_p > -12:
...
if __name__ == "__main__":
    ...
    message_body = ''
    for work_instructions in message_to_send:
